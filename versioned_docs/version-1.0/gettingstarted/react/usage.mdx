...
An input component is standardized, it follows the [input interface api](../../reference/input)
...
import Notifiles from '@notifiles/react'
import OvideLocal from 'components/notifiles-library'
